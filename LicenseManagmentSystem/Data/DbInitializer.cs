...
namespace LicenseManagmentSystem.Data
{
    public static class DbInitializer
    {
        public static void Initialize(ManagerContext context)
        {
            ...
            {
            new LicenseKey{CustomerID=1,ProductID=1050,ExpiryDate=DateTime.Parse("2005-05-03")},
            new LicenseKey{CustomerID=1,ProductID=4022,ExpiryDate=DateTime.Parse("2007-09-01")},
            new LicenseKey{CustomerID=1,ProductID=4041,ExpiryDate=DateTime.Parse("2005-06-17")},
            new LicenseKey{CustomerID=2,ProductID=4041,ExpiryDate=DateTime.Parse("2005-09-22")},
            new LicenseKey{CustomerID=2,ProductID=4022,ExpiryDate=DateTime.Parse("2005-05-13")},
            new LicenseKey{CustomerID=2,ProductID=1050,ExpiryDate=DateTime.Parse("2005-08-20")},
            new LicenseKey{CustomerID=3,ProductID=1050,ExpiryDate=DateTime.Parse("2006-04-21")},
            new LicenseKey{CustomerID=4,ProductID=1050,ExpiryDate=DateTime.Parse("2005-07-05")},
            new LicenseKey{CustomerID=4,ProductID=4022,ExpiryDate=DateTime.Parse("2005-06-06")},
            new LicenseKey{CustomerID=5,ProductID=4041,ExpiryDate=DateTime.Parse("2007-09-01")},
            new LicenseKey{CustomerID=6,ProductID=1050,ExpiryDate=DateTime.Parse("2005-08-01")},
            new LicenseKey{CustomerID=7,ProductID=4022,ExpiryDate=DateTime.Parse("2006-09-03")},
            };
